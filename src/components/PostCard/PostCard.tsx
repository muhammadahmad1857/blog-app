...
//         <div className="max-w-sm h-full shadow-lg  shadow-gray-700 bg-white m-4 hover:shadow-xl hover:shadow-gray-700 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between">
//           {/* Post Image */}
//           <div className="p-4">
//             <Avatar
//               radius="lg"
